<?php 
    ...
    //     mysqli($conn, 'INSERT INTO profil (punkty, punkty_alltime) VALUES (($_SESSION["punkty"] + score), ($_SESSION["punkty_alltime"] + score)) WHERE id_profil = $_SESSION["id_profil"]');
    //     header("Location: ../html/minigra.php");
    // } 
    include('../php/database.php');
    ...
    window.setTimeout(function time() {
        ...
        document.writeln('<?php if(".$_SESSION['zalogowany'].") {mysqli(".$conn.", 'INSERT INTO profil (punkty, punkty_alltime) VALUES ((".$_SESSION['punkty']." + score), (".$_SESSION['punkty_alltime']." + score)) WHERE id_profil = ".$_SESSION['id_profil'].");} header('Location: ../html/minigra.php');?>);
        on = false;
